...
-- Absolute path for docker implementation
LOAD DATA LOCAL INFILE '/docker-entrypoint-initdb.d/Helsingin_ja_Espoon_kaupunkipyöräasemat_avoin.csv' 
    INTO TABLE station 
    FIELDS 
        TERMINATED BY ','
        ENCLOSED BY '"'
...
-- Absolute path for docker implementation
LOAD DATA LOCAL INFILE '/docker-entrypoint-initdb.d/validated_bike_data.csv' 
    INTO TABLE journey 
    FIELDS 
        TERMINATED BY ','
        ENCLOSED BY '"'
